...
class SpotifyAPI(object):
    ...
    def get_client_credentials(self):
        '''
        returns base 64 strings
        '''
        client_id = self.client_id
        client_secret = self.client_secret
        if client_secret == None or client_id == None:
            raise Exception('Could not authenticate client id or secret')
...
# methods above authorize credentials and get access token
# methods below are basic search function to recieve song_id, artist_id, and album_id
# lookup_id is the unique identifier within the endpoint generated by spotify
